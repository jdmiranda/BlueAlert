...
(function() {
    ...
    document.getElementById('whereamiButton').addEventListener('click', function() {
      getLocationUpdate();
      ...
      document.getElementById('gofundmeButton').addEventListener('click', function() {
        window.location.href = "https://www.gofundme.com/f/stopp-sharing-the-optimum-peoples039-perspective";
      });

      document.getElementById('cameraButton').addEventListener('click', function() {
        window.location.href = "https://jdmiranda.github.io/camera/";
      });
